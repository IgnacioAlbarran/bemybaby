...
class BabiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create baby" do
    assert_difference('Baby.count') do
      post babies_url, params: { baby: { blood_type: @baby.blood_type, dob: @baby.dob, gender: @baby.gender, last_name: @baby.last_name, name: @baby.name } }
    end
  ...
  test "should update baby" do
    patch baby_url(@baby), params: { baby: { blood_type: @baby.blood_type, dob: @baby.dob, gender: @baby.gender, last_name: @baby.last_name, name: @baby.name } }
