...
RSpec.describe WeightsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: weight.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      weight = Weight.create! valid_attributes
      get :edit, params: {id: weight.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Weight" do
        expect {
          post :create, params: {weight: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {weight: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested weight" do
        weight = Weight.create! valid_attributes
        put :update, params: {id: weight.to_param, weight: new_attributes}, session: valid_session
        weight.reload
      ...
      it "redirects to the weight" do
        weight = Weight.create! valid_attributes
        put :update, params: {id: weight.to_param, weight: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        weight = Weight.create! valid_attributes
        put :update, params: {id: weight.to_param, weight: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested weight" do
      weight = Weight.create! valid_attributes
      expect {
        delete :destroy, params: {id: weight.to_param}, session: valid_session
      }.to change(Weight, :count).by(-1)
    end
